package com.zhaoyunfei.javacc.module.parser;/* Generated By:JavaCC: Do not edit this line. ActionDebugParser.java */
...
@Slf4j
public class ActionDebugParser implements ActionParserConstants {
    ...
    while (true) {
      ...
      case BREAK:
        jj_consume_token(BREAK);
            breakLoop = true; currentLine=token.endLine;parsingListener.onParsingRead(currentLine,1);breakpoint();
        break;
      case CONTINUE:
        jj_consume_token(CONTINUE);
                this.continueLoop=true;currentLine=token.endLine;parsingListener.onParsingRead(currentLine,1);breakpoint();
        break;
      default:
        jj_la1[11] = jj_gen;
        jj_consume_token(-1);
...
// for循环:解析的文本为 for i=0,2,1 do ...end 以及 for count=1,10 do ...end 循环执行10�?
  ...
  Token[] savedTokens = new Token[1];
   currentLine=token.beginLine;parsingListener.onParsingRead(currentLine,0);
    ...
    jj_consume_token(EQUALTO);
    jj_consume_token(NUMBER);
             start = Integer.parseInt(token.image);  variables.put(identy,(float)start);
  ...
  final public void forConditionStatement() throws ParseException {
    ...
    while (true) {
      ...
      case BREAK:
        jj_consume_token(BREAK);
                   this.breakLoop = true;currentLine=token.endLine;parsingListener.onParsingRead(currentLine,1);breakpoint();
        break;
      case CONTINUE:
        jj_consume_token(CONTINUE);
                      this.continueLoop=true;currentLine=token.endLine;parsingListener.onParsingRead(currentLine,1);breakpoint();
...
// ptp动作解析并执�?(调度系统内接�?)
  final public boolean ptpAction() throws ParseException {
    jj_consume_token(PTP);
         currentLine=token.endLine;parsingListener.onParsingRead(currentLine,0); {if (true) return executePtpAction(parameters());}
    throw new Error("Missing return statement in function");
  }
  ...
  final public boolean linAction() throws ParseException {
    jj_consume_token(LIN);
         currentLine=token.endLine;parsingListener.onParsingRead(currentLine,0);{if (true) return executeLinAction(parameters());}
    throw new Error("Missing return statement in function");
  }
  ...
  final public boolean arcAction() throws ParseException {
    jj_consume_token(ARC);
         currentLine=token.endLine;parsingListener.onParsingRead(currentLine,0); {if (true) return executeArcAction(parameters());}
    throw new Error("Missing return statement in function");
  }
  ...
  final public boolean circleAction() throws ParseException {
    jj_consume_token(CIRCLE);
            currentLine=token.endLine;parsingListener.onParsingRead(currentLine,0);{if (true) return executeCircleAction(parameters());}
    throw new Error("Missing return statement in function");
  }
  ...
  public ActionDebugParser(java.io.InputStream stream,IExecuteService iExecuteService,ParsingListener parsingListener) {
     this(stream, null,iExecuteService,parsingListener);
  }
  /** Constructor with InputStream and supplied encoding */
  public ActionDebugParser(java.io.InputStream stream, String encoding,IExecuteService iExecuteService,ParsingListener parsingListener) {
  ...
  /** Constructor. */
  public ActionDebugParser(java.io.Reader stream) {
  ...
  public ActionDebugParser(ActionParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
